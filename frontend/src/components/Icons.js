...
export function GithubIcon(p) {
  return <svg {...base(p, { fill: 'currentColor', stroke: 'none' })}><path d="M7 1.5A5.5 5.5 0 001.5 7c0 2.43 1.57 4.48 3.75 5.21.27.05.37-.12.37-.26v-.94c-1.52.33-1.84-.66-1.84-.66-.25-.63-.61-.8-.61-.8-.5-.34.04-.33.04-.33.55.04.84.57.84.57.49.84 1.28.6 1.59.46.05-.36.19-.6.35-.74-1.21-.14-2.49-.61-2.49-2.7 0-.6.21-1.09.56-1.47-.06-.14-.24-.7.05-1.45 0 0 .46-.15 1.5.56.44-.12.9-.18 1.37-.18s.93.06 1.37.18c1.04-.71 1.5-.56 1.5-.56.29.75.11 1.31.05 1.45.35.38.56.87.56 1.47 0 2.1-1.28 2.56-2.5 2.7.2.17.37.5.37.99v1.47c0 .14.1.31.37.26A5.5 5.5 0 0012.5 7 5.5 5.5 0 007 1.5z" /></svg>;
}
